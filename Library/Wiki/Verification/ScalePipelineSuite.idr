...
runScalePipelineSuite = runTestSuite "Functorial Scale Pipeline & Galois Adjunctions (Tests 135 - 166, 172 - 173)"
  ...
  , MkTestCase 144 "Biological Ribosomal Translation & Biomolecules" auditFunctorialPipelineProofExport
  ...
  , MkTestCase 148 "Full Standard Model Particle Catalog & Multiset Vertices" auditFunctorialPipelineProofExport
  , MkTestCase 149 "High-Energy 2-to-2 Particle Scattering Kinematics" auditFunctorialPipelineProofExport
  , MkTestCase 150 "Hadronization & QGP Jet Fragmentation Automaton" auditFunctorialPipelineProofExport
  , MkTestCase 151 "3-Flavor Neutrino Oscillation Time-Series & PMNS" auditNeutrinoOscillationProofExport
  , MkTestCase 152 "Universal Transform Multiset Factorization (G ⊗ Z ⊗ J)" auditFunctorialPipelineProofExport
  ...
  , MkTestCase 161 "Discrete Higgs Mechanism Potential & Symmetry Breaking (V(φ), m_W, m_H)" auditFunctorialPipelineProofExport
  , MkTestCase 162 "1-Loop Discrete Vacuum Polarization & Running Fine Structure Coupling α(q^2)" auditFunctorialPipelineProofExport
